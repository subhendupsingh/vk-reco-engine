...
@Entity
public class SdSales implements Serializable{
	...
	public int getMarkedreturn() {
		return markedreturn;
	}
	public void setMarkedreturn(int markedreturn) {
		this.markedreturn = markedreturn;
	}
